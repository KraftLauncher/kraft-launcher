...
class PlatformSecureStorageSupport {
  ...
  Future<bool> isSupported() async {
    return switch (currentDesktopPlatform) {
      ...
      // TODO: Accessing macOS keychain requires app registration with Apple, and the app
      //  is not registered yet for now. Once the app is registered, update this to true
